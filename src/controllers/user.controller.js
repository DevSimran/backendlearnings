...
const updateUserCoverImaage = asyncHandller(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, user, "Cover Image updated Succeffully"));
});

const getUserChannelProfile = asyncHandller(async (req, res) => {
...
const getWatchHistory = asyncHandller(async(req, res)=>{
